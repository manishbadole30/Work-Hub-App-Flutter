...
import 'package:work_hub_app/Jobs/upload_task.dart';
import 'package:work_hub_app/Search/profile_workers.dart';
import 'package:work_hub_app/Search/search_workers.dart';
  ...
  Widget build(BuildContext context) {
    return CurvedNavigationBar(
      ...
      onTap: (index)
      {
        ...
        {
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => const UploadTaskNow()));
        }
        else if(index == 3)
        {
          final FirebaseAuth _auth = FirebaseAuth.instance;
